...
const PengeluaranSaldoScreen = ({ navigation }) => {
  ...
  const handleSave = () => {
    ...
    const newTransaction = {
      ...
      category: kategori,
      amount: amount,
      description: catatan || `Pengeluaran: ${kategori}`,
      icon: 'cash-minus',
      source: sumberDana,
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.headerContainer}>
            ...
            <Text style={styles.headerTitle}>{t('expenseBalanceTitle')}</Text>
            <Text style={styles.headerSubtitle}>{t('expenseBalanceSubtitle')}</Text>
          </View>
